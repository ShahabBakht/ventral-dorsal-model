...
class DPC_RNN(nn.Module):
    ...
    def __init__(self, sample_size, num_seq=8, seq_len=5, pred_step=3, network='resnet50'):
        ...
        if network == 'vgg' or network == 'mousenet' or network == 'simmousenet' or network == 'monkeynet_p1'or network == 'monkeynet_p2':
        ...
        if network == 'resnet0':
            ...
            self.last_size = 16
            self.pool_size = 1
        elif network == 'monkeynet_p1' or network == 'monkeynet_p2':
            self.last_size = 16
            self.pool_size = 1
        else:
