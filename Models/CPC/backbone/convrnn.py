...
if __name__ == '__main__':
    crnn = ConvGRU(input_size=3, hidden_size=20, kernel_size=3, num_layers=1)
    data = torch.randn(20, 5, 3, 64, 64)#torch.randn(4, 5, 10, 6, 6) # [B, seq_len, C, H, W], temporal axis=1
    output, hn = crnn(data)
