...
__all__ = [
    ...
    'resnet152_2d3d_full', 'resnet200_2d3d_full', 'resnet_basic_2d3d_full','ResNet2d3d_basic',
]
...
# added by Shahab    
class ResNet2d3d_basic(nn.Module):
    def __init__(self, block, layers, track_running_stats=True):
        super(ResNet2d3d_basic, self).__init__()
        self.inplanes = 64
        self.track_running_stats = track_running_stats
        bias = False
        self.conv1 = nn.Conv3d(3, 64, kernel_size=(1,7,7), stride=(1, 2, 2), padding=(0, 3, 3), bias=bias)
...
## full resnet
# added by Shahab
def resnet_basic_2d3d_full(**kwargs):
    '''Constructs a ResNet-18 model. '''
    model = ResNet2d3d_basic([BasicBlock2d,BasicBlock3d], 
                   [1,1], **kwargs)
    return model
